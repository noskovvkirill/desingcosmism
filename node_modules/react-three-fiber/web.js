...
function ResizeContainerComponent(props) {
  ...
  const containerRef = useRef(null); // onGotPointerCaptureLegacy is a fake event used by non-web targets to simulate poinzter capture
  ...
  const memoStyle = useMemo(() => ({ ...defaultStyles,
    ...style
  ...
  return /*#__PURE__*/createElement("div", _extends({
    ref: mergeRefs([useMeasureRef, containerRef]),
    style: memoStyle
  }, events, restSpread), preRender, ready && /*#__PURE__*/createElement(Content, _extends({}, props, state)));
}

const ResizeContainer = /*#__PURE__*/memo(ResizeContainerComponent);
...
function CanvasComponent({
  ...
  const Renderer = useMemo(() => props.webgl1 ? WebGL1Renderer : WebGLRenderer, [props.webgl1]);
  const renderer = useCallback(function callback() {
  ...
  const preRender = useMemo(() => /*#__PURE__*/createElement("canvas", {
    ref: canvasRef,
    style: canvasStyle
  }), []);
  return /*#__PURE__*/createElement(ResizeContainer, _extends({}, props, {
    renderer: renderer,
    preRender: preRender
  }), children);
}
