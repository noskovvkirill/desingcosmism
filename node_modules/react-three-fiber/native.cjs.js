...
function useCanvas(props) {
  ...
  }, [invalidateFrameloop, vr, concurrent, noEvents, ready, size, defaultCam, gl, getCurrentViewport]); // Adjusts default camera
  ...
  var handlePointerCancel = React.useCallback(function (event, hits, prepare) {
    ...
    if (prepare) prepareRay(event); // commenting this out as I believe it is unnecessary and causes a recursive dependency
  ...
  }, [shadowMap, colorManagement, gl]); // This component is a bridge into the three render context, when it gets rendered
...
function useLoader(Proto, input, extensions, onProgress) {
  ...
  var results = useAsset.useAsset(loadingFn(extensions, onProgress), [Proto, input]); // Return the object/s
...
function IsReadyComponent(_ref) {
  var gl = _ref.gl,
...
var IsReady = /*#__PURE__*/React.memo(IsReadyComponent);
...
function CanvasComponent(props) {
  ...
  var onLayout = React.useCallback(function callback(e) {
  ...
  function onContextCreate(_x) {
    return _onContextCreate.apply(this, arguments);
  }

  function _onContextCreate() {
    _onContextCreate = _asyncToGenerator__default['default']( /*#__PURE__*/regeneratorRuntime.mark(function _callee(gl) {
  ...
  var setNativeRef = React.useCallback(function callback(ref) {
  ...
  var style = React.useMemo(function () {
    return _extends__default['default']({}, styles, props.style);
  }, [props.style]); // 1. Ensure Size
...
var Canvas = /*#__PURE__*/React.memo(CanvasComponent);
