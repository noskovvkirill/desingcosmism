...
function Content(_ref) {
  ...
  // Create renderer
  var _React$useState = React.useState(renderer),
      gl = _React$useState[0];
...
function ResizeContainerComponent(props) {
  ...
  var containerRef = React.useRef(null); // onGotPointerCaptureLegacy is a fake event used by non-web targets to simulate poinzter capture

  var _React$useState2 = React.useState({}),
      _React$useState2$ = _React$useState2[0],
      onGotPointerCaptureLegacy = _React$useState2$.onGotPointerCaptureLegacy,
      events = _objectWithoutPropertiesLoose__default['default'](_React$useState2$, ["onGotPointerCaptureLegacy"]),
  ...
  var memoStyle = React.useMemo(function () {
    return _extends__default['default']({}, defaultStyles, style);
  }, [style]); // Allow Gatsby, Next and other server side apps to run. Will output styles to reduce flickering.
  ...
  return /*#__PURE__*/React.createElement("div", _extends__default['default']({
    ref: mergeRefs__default['default']([useMeasureRef, containerRef]),
    style: memoStyle
  }, events, restSpread), preRender, ready && /*#__PURE__*/React.createElement(Content, _extends__default['default']({}, props, state)));
}

var ResizeContainer = /*#__PURE__*/React.memo(ResizeContainerComponent);
...
function CanvasComponent(_ref) {
  ...
  var Renderer = React.useMemo(function () {
    return props.webgl1 ? THREE.WebGL1Renderer : THREE.WebGLRenderer;
  }, [props.webgl1]);
  var renderer = React.useCallback(function callback() {
    if (canvasRef.current !== null) {
      ...
      var temp = new Renderer(_extends__default['default']({
  ...
  var preRender = React.useMemo(function () {
    return /*#__PURE__*/React.createElement("canvas", {
      ref: canvasRef,
      style: canvasStyle
    });
  }, []);
  return /*#__PURE__*/React.createElement(ResizeContainer, _extends__default['default']({}, props, {
    renderer: renderer,
    preRender: preRender
  }), children);
}
