...
export declare type Vector2 = THREE.Vector2 | Parameters<THREE.Vector2['set']>;
export declare type Vector3 = THREE.Vector3 | Parameters<THREE.Vector3['set']>;
export declare type Color = THREE.Color | number | string;
export declare type Layers = THREE.Layers | Parameters<THREE.Layers['set']>;
...
export declare type GeometryNode<T extends THREE.Geometry, P> = Overwrite<Node<T, P>, {
    vertices?: Vector3[];
}>;
...
export declare type GeometryProps = GeometryNode<THREE.Geometry, typeof THREE.Geometry>;
...
export declare type ParametricGeometryProps = GeometryNode<THREE.ParametricGeometry, typeof THREE.ParametricGeometry>;
export declare type TetrahedronGeometryProps = GeometryNode<THREE.TetrahedronGeometry, typeof THREE.TetrahedronGeometry>;
export declare type OctahedronGeometryProps = GeometryNode<THREE.OctahedronGeometry, typeof THREE.OctahedronGeometry>;
export declare type IcosahedronGeometryProps = GeometryNode<THREE.IcosahedronGeometry, typeof THREE.IcosahedronGeometry>;
export declare type DodecahedronGeometryProps = GeometryNode<THREE.DodecahedronGeometry, typeof THREE.DodecahedronGeometry>;
export declare type PolyhedronGeometryProps = GeometryNode<THREE.PolyhedronGeometry, typeof THREE.PolyhedronGeometry>;
export declare type TubeGeometryProps = GeometryNode<THREE.TubeGeometry, typeof THREE.TubeGeometry>;
export declare type TorusKnotGeometryProps = GeometryNode<THREE.TorusKnotGeometry, typeof THREE.TorusKnotGeometry>;
export declare type TorusGeometryProps = GeometryNode<THREE.TorusGeometry, typeof THREE.TorusGeometry>;
export declare type TextGeometryProps = GeometryNode<THREE.TextGeometry, typeof THREE.TextGeometry>;
export declare type SphereGeometryProps = GeometryNode<THREE.SphereGeometry, typeof THREE.SphereGeometry>;
export declare type RingGeometryProps = GeometryNode<THREE.RingGeometry, typeof THREE.RingGeometry>;
export declare type PlaneGeometryProps = GeometryNode<THREE.PlaneGeometry, typeof THREE.PlaneGeometry>;
export declare type LatheGeometryProps = GeometryNode<THREE.LatheGeometry, typeof THREE.LatheGeometry>;
export declare type ShapeGeometryProps = GeometryNode<THREE.ShapeGeometry, typeof THREE.ShapeGeometry>;
export declare type ExtrudeGeometryProps = GeometryNode<THREE.ExtrudeGeometry, typeof THREE.ExtrudeGeometry>;
export declare type EdgesGeometryProps = BufferGeometryNode<THREE.EdgesGeometry, typeof THREE.EdgesGeometry>;
export declare type ConeGeometryProps = GeometryNode<THREE.ConeGeometry, typeof THREE.ConeGeometry>;
export declare type CylinderGeometryProps = GeometryNode<THREE.CylinderGeometry, typeof THREE.CylinderGeometry>;
export declare type CircleGeometryProps = GeometryNode<THREE.CircleGeometry, typeof THREE.CircleGeometry>;
export declare type BoxGeometryProps = GeometryNode<THREE.BoxGeometry, typeof THREE.BoxGeometry>;
...
export declare type Face3Props = Node<THREE.Face3, typeof THREE.Face3>;
export declare type ColorProps = Node<THREE.Color, typeof THREE.Color>;
